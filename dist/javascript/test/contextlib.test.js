import { contextmanager, With, Use, ContextManagerBase, ExitStack, suppress, timed, closing } from '../src/contextlib';
...
test(`When multiple errors occur in an exitstack, the last error would be thrown`, () => {
    const buggycm = contextmanager(function* buggycm(id) {
        yield id;
