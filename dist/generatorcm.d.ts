...
declare type GeneratorFunction<Yield, Args extends any[]> = (...args: Args) => Generator<Yield>;
declare type GeneratorFunctionWrapper<Yield, Args extends any[]> = (...args: Args) => GeneratorContextManager<Yield>;
 ...
 */
declare function contextmanager<T, Args extends any[]>(func: GeneratorFunction<T, Args>): GeneratorFunctionWrapper<T, Args>;
