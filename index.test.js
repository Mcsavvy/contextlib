// import { contextmanager, With, ContextManagerBase, ExitStack, suppress, timed, closing } from './index';

var { contextmanager, With, ContextManagerBase, ExitStack, suppress, timed, closing } = require('./index')
...
test(`When multiple errors occur in an exitstack, the last unsuppressed error would be thrown`, () => {
...
test('Any error in the body of a context would be thrown in the context manager', () => {
...
test("errors can be suppressed using context managers when the exit method returns true", () => {
    expect(() => {
